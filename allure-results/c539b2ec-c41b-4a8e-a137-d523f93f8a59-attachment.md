...
Call log:
  - waiting for getByTitle('User dropdown')
        ...
        - generic [ref=e146]:
          - generic [ref=e147]:
            ...
            - generic [ref=e150]:
              ...
              - paragraph [ref=e152]: "Punched Out: Today at 09:38 PM (GMT 5.5)"
          - generic [ref=e153]:
            - generic [ref=e154]: 0h 5m Today
      ...
      - generic [ref=e250]:
        ...
        - generic [ref=e257]:
          - generic [ref=e258]:
            ...
            - separator [ref=e265]
            - paragraph [ref=e266]: "Hi Aamandeep; Linda has been blessed with a baby boy! Linda: With love, we welcome your dear new baby to this world. Congratulations!"
          - generic [ref=e267]:
...
```ts
  ...
  11 | 
> 12 |    await page.getByTitle('User dropdown').click();
     |                                           ^ Error: locator.click: Test timeout of 30000ms exceeded.
  13 | 
  14 | 
  15 | })
