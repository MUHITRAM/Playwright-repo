...
- Name: Sample.spec.js >> navigation
- Location: tests/Sample.spec.js:24:2
...
Expected: "Demo Web Shop. Search"
Received: "Demo Web Shop"
Timeout:  5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    14 × unexpected value "Demo Web Shop"
...
```ts
  ...
  6  | //     await page.locator('//input[@class="button-1 search-box-button"]').click()
  7  | //     await page.goBack()
  ...
  23 | 
  24 |  test('navigation',async({page})=>{
  25 | await page.goto('https://demowebshop.tricentis.com/')
  26 | 
> 27 | await expect(page).toHaveTitle('Demo Web Shop. Search');
     |                    ^ Error: expect(page).toHaveTitle(expected) failed
  28 |     
  29 | 
  30 | 
