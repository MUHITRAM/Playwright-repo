...
Call log:
  - waiting for locator('.button-1 search-box-button')
              ...
              - generic [ref=e243]:
                - heading "14.1-inch Laptop" [level=2] [ref=e244]:
                  - link "14.1-inch Laptop" [ref=e245] [cursor=pointer]:
                    - /url: /141-inch-laptop
                - generic "1724 review(s)" [ref=e246]
                - generic [ref=e249]:
...
```ts
  ...
  6  | 
  7  |    await page.locator('#small-searchterms').fill("laptop")
> 8  |    await page.locator('.button-1 search-box-button').click()
     |                                                      ^ Error: locator.click: Test timeout of 30000ms exceeded.
